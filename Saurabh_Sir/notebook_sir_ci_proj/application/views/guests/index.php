								...
								<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
									<div class="panel panel-default">
										...
										<form method="post" action="<?= $export_action?>">
											...
											<input type="text" class="guestidcollect" name="guestidcollect"/>
										</form>
												...
												<tbody>
													...
													<tr>
														...
														<td>
															...
															<a href="<?php echo site_url('Guests/update/'.base64_encode($guestrow->token));?>" class="glyphicon glyphicon-edit btn text-primary">Update</a>
