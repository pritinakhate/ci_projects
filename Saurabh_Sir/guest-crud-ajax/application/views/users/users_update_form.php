								...
								<div class="panel panel-default">						
									...
									<div class="panel-body">  
										...
										<div class="form-group">
											...
											<div>
												<input type="text" class="form-control" name="dob" id="dobpicker" readonly="true" value="<?= !empty($dob)?$dob:''; ?>" placeholder="Select Your Date"/>
											</div>
										</div>										
										<div class="form-group">
											<label>Gender </label><span class="text text-danger"> * <?= form_error('dob');?></span>
											<div class="push-left">
										...
										<div class="form-group">
											<label>Photo : </label>
											<div>
												<input type="hidden" name="old_photo" value="<?= $photo; ?>" class="form-control"/>
										...
										<div class="form-group">
											...
											<div class="push-left">
												...
												value="Active" <?= !empty($status) && $status=='Active' ?'checked':''; ?>> Active
												</label>
												<label class="radio-inline">
													<input type="radio" name="status" value="Block" <?= !empty($status) && $status=='Block' ?'checked':''; ?>> Block
												</label>
												<label class="radio-inline">
													<input type="radio" name="status" value="Pending" <?= !empty($status) && $status=='Pending' ?'checked':''; ?>> Pending
												</label>
											</div>
										</div>	
										<?php } ?>
