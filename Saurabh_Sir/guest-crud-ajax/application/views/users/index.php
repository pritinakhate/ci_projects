	...
	<body>
		<div class="container-fluid"> <!-- Container start -->
			...
			<div class="row"><!-- second row start-->
				<div class="col-md-2 col-sm-2 col-xs-12 example-navbar-collapse content height dash-height" > <!-- Left Pannel start -->
				...
				<div class="col-md-10 col-sm-10 col-xs-12 col-lg-10 height"> <!-- Right Pannel start -->
					<div><h2><?= $screen; ?></h2><hr/></div>
							...
							<div class="row">
									...
									<div class="panel panel-default">
										...
										<div class="table-responsive">
											<table class="table table-striped table-bordered datatablelist">
												...
												<tbody>
													<?php $i=1; foreach($maleguest as $malerecords) {?>
													<tr>
													<td><?php echo $i;?></td>
													...
													<td>
															...
															<span class="label label-success"><?= $malerecords->status; ?></span>
															<?php } else if($malerecords->status == "Block") { ?>
															<span class="label label-danger"><?= $malerecords->status; ?></span>
															<?php } else { ?>
															<span class="label label-warning"><?= $malerecords->status; ?></span>
															<?php } ?>
														</td>
													</tr>
													<?php $i++; }?>
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"> <!--second table Start -->
									<div class="panel panel-default">
										<div class="panel-heading">
										...
										<div class="table-responsive">
											<table class="table table-striped table-bordered datatablelist">
												...
												<tbody>
													<?php $j=1; foreach($femaleguest as $femalerecord) {?>
													<tr>
													<td><?php echo $j;?></td>
													...
													<td>
														...
														<span class="label label-success"><?= $femalerecord->status; ?></span>
														<?php } else if($femalerecord->status == "Block") { ?>
														<span class="label label-danger"><?= $femalerecord->status; ?></span>
														<?php } else { ?>
														<span class="label label-warning"><?= $femalerecord->status; ?></span>
														<?php } ?>
													</td>
													</tr>
													<?php $j++; }?>
									...
									<div class="panel panel-default">
										...
										<div class="table-responsive">
											<table class="table table-striped table-bordered datatablelist">
												...
												<tbody>
													<?php $a=1; foreach($activeusers as $activerecord) {?>
													<tr>
													<td><?= $a; ?></td>
													...
													<td>
														...
														<span class="label label-success"><?= $activerecord->status; ?></span>
														<?php  }  ?>
													</td>
													</tr>
													<?php $a++; }?>
									...
									<div class="panel panel-default">
										...
										<div class="table-responsive">
											<table class="table table-striped table-bordered datatablelist">
												...
												<tbody>
													<?php $b=1; foreach($blockusers as $blockrecord) {?>
													<tr>
													<td><?= $b; ?></td>
									...
									<div class="panel panel-default">
										...
										<div class="table-responsive">
											<table class="table table-striped table-bordered datatablelist">
												...
												<tbody>
													<?php $c=1; foreach($pendingusers as $pendingrecord) { ?>
													<tr>
													<td><?= $c; ?></td>
													...
													<td>
														...
														<span class="label label-warning"><?= $pendingrecord->status; ?></span>
														<?php  }  ?>
													</td>
													</tr>
													<?php $c++; }?>
