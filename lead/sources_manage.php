...
if(isset($_POST['deleteall']))
{
        ...
        foreach($ids as $id)
	{
		...
		$getsourcesdata = mysqli_fetch_assoc(mysqli_query($conn,"select id from lead_sources where id='$id'"));
		
		//to check whether countryid is associated with users or not
		$checklead = mysqli_fetch_assoc(mysqli_query($conn,"select id from leads where source_id='".$getsourcesdata['id']."'"));
		...
		if(!$checklead)
		{
            mysqli_query($conn,"delete from lead_sources where id='".$getsourcesdata['id']."'");
			$del++;
			
		}
		else
		{
            echo"This sources already mapped";
			$nondel++;
...
$getallsources = mysqli_query($conn,"SELECT * FROM lead_sources ORDER BY id DESC")
...
<body>
    <div class="container w-75">
        ...
        <div class="panel-heading">
            <h3 class="panel-title text-center mt-3">Sources List</h3>
        </div>
        <br />
        ...
        <div><a class="btn btn-primary float-end" href="source_create.php" role="button">Create</a></div>
            ...
            ?>
                        <tr>
                            ...
                            <td><button type="button" class="btn">
                                    <a href="sources_update.php?id=<?php echo $row['id']; ?>"><i style="color: #c98a1e;"
                                            class="fa-solid fa-pencil"></i></a>
                                </button>
                                <button type="button" class="btn">
                                    <a href="sources_delete.php?id=<?php echo $row['id'];?>"><i style="color: #d80827; "
