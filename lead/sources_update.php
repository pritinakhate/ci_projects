...
$ans = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM lead_sources WHERE id = '$update_id'"));
...
if(isset($_POST['save'])){
  $errors = sources_validation();
    ...
    $update_sources ="UPDATE lead_sources SET
    title_sources = '".$_POST['name']."',
    ...
    if (mysqli_query($conn, $update_sources )) {
        $massage = "lead sources has been updated successfully";
      } else {
    ...
    <div class="panel-heading">
      <h3 class="text-center">List Of Lead Source</h3>
          ...
          <div class="text-center mt-5">
            <?php if(isset($massage) && ($massage == "lead sources has been updated successfully")) { ?>
    ...
    <div class="container w-50 mt-5 ">
      <div class="mb-3">
        ...
        <input type="text" class="form-control" name="name" 
          value="<?php echo (isset($ans['title_sources'])) ? $ans['title_sources'] : ''; ?>" placeholder="title">
      </div>
      <div class="mb-3">
