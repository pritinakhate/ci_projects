...
<body>
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            <div class="container " style="margin: 100px 200px ;" id="container-wrapper">
                ...
                <head>
                    ...
                    * {
                    ...
                    <form method="post" action='<?php echo site_url('Users/update_passwordadmin/'.$id) ?>'>
                        <div class="containers w-50 d-flex " style="background-color: white; margin-left:50px">
                            <div class="row col-6">
                            ...
                            <div class="col-6 ms-5 w-25 ">
                                <img src="<?php echo base_url('assets/change_pass1.jpg') ?>"
                                    style="background-size: cover; height:500px; margin-left:50px">
                            </div>
                        </div>
